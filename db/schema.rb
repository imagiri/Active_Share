...
ActiveRecord::Schema.define(version: 2019_09_10_042307) do
  ...
  create_table "diarys", force: :cascade do |t|
    ...
    t.bigint "user_id"
    t.index ["user_id"], name: "index_diarys_on_user_id"
  end
